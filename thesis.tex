...
Twitch ist eine Web Video Plattform welche von Amazon betrieben wird. Sie wird besonders zum Live Streamen von Videospielen eingesetzt. Im März 2020 verzeichnete Sie durchschnittlich 1,44 Mio gleichzeitige Zuschauer. Im gleichen Zeitraum streamten durchschnittlich 56,000 Streamer die konsumierten Inhalte \parencite{Iqbal2020}

Seinen Ursprung hat Twitch auf der Live Video Plattform Justin.tv. Aufgrund der hohen Anfrage von Videospiel Content auf dieser Seite wurde eine zweite Seite dediziert für Videospiele mit dem heute bekannten Namen Twitch gestartet welche im Jahr 2011 ans Netz ging. Später wurde auch der Name der Firma in Twitch umbenannt. Im Jahr 2014 wurde Twitch von Amazon gekauft und ist seitdem der Betreiber.

Auf Twtich gibt es die sogenannten Channels (dt. Kanäle). Jeder Twitch User hat einen eigenen Channel auf dem er LIVE Video Streams zur Verfügung stellen kann. Die Plattform ist für beide Seiten komplett kostenlos. Sowohl Zuschauer Seite als auch die Seite des Streamers. 

Für das Konsumieren der Inhalte der Plattform benötigt man keinen Account. Möchte man aber in einer Chat Diskussion teilnehmen, einem Channel folgen oder selbst streamen muss man sich einen Account erstellen und mit diesem angemeldet sein.

Auf der Startseite von Twitch bekommt der User Inhalte vorgeschlagen die ihm gefallen könnten. Darunter viele Kanäle die aktuell Live sind. Jeder Stream wird einer Kategorie zugeordnet wobei eine Kategorie in der Regel ein Video Spiel ist. Die beliebtesten Spiele aller Zeiten auf Twitch  laut Statista können der nachstehenden Tabelle entnommen werden. \parencite{Statista2020}
...
Die Subscribtions bzw Abbonements sind sind eine Möglichkeit einen Streamer auf monatlicher Basis zu unterstützen. Es gibt drei Stufen, die sogenannten "Tiers". Die Kosten der jeweiligen Stufen können \autoref{tab:tierPreise} entnommen werden. Der Streamer erhält von den Kosten als Affiliate jeweils 50\%.  Die andere Hälfte behält Twitch. Als Partner ist die Teilung bei 50/50, 60/40 und 70/30 für Tier 1, 2 und 3. 
...
Als zusätzlicher Druck ist die Zeit in der der HypeTrain bezwungen werden kann begrenzt.
...
Oberhalb des Chats gibt es ein Leaderboard. In diesem werden die Top 10 Sub Gifter und die Top 10 Bitter des Streamers angezeigt. Der Streamer kann bestimmen ob es die Top 10 des Monats oder die Top 10 of All Time sein sollen.
...
Online Marketing ist ein sehr großes Feld und umfasst viele verschiedene Bereiche. Die verschiedenen Bereichen können einzeln angewendet werden, miteinander verknüpft oder Schnittmengen bilden. Auf Twitch werden verschiedene Formen des Online Marketings angewandt. Im folgenden werden die verschiedenen Formen anhand von Beispielen erklärt.

\section{Video Marketing}
Video Marketing ist der Einsatz von interessante und fesselnden Videos in einer Marketing Kampagne. Die Bandbreite von Video Marketing ist sehr groß. Sie reicht vom stärken der Kundenbindung hin zum bewerben von Firmen, Produkten oder Dienstleistungen. Zudem kann es als Medium für Live Streams  oder viraler unterhaltsamer Content. --> um nur ein paar Beispiele zu nennen. \parencite{Stringfellow2017}

Da Twitch eine reine Video Plattform ist ist Video Marketing hier auch nicht wegzudenken.
...
Twitch wurde im Jahr 2019 der "Best Video Marketing and Advertising Platform" Award verliehen. \parencite{DigidayAwards2019} Das Alleine zeigt schon wie viel Potential in Video Marketing auf Twitch steckt.
...
Firmen können auf Twitch Banner Werbung schalten. Diese wird in verschiedenen Bereichen der Plattform angezeigt. \parencite{Twitch2020}
