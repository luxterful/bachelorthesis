...
\label{chap:bllshit}
Wurde eine Subscription gekauft, so wird diese im Chat besonders hervorgehoben, wodurch sich die Käuferinnen und Käufer mehr wertgeschätzt fühlen (Core Drive 2 und 5). Hat ein Mitglied zum ersten Mal eine Subscription gekauft, wird diese Nachricht automatisch angezeigt, um ihm diese Funktion näher zu bringen (Core Drive 7). Im Fall einer Erneuerung der Subscription kann selbst bestimmt werden, wann die Mitteilung angezeigt werden soll. Dabei hat es nun auch die Möglichkeit, eine Nachricht zu schreiben, die innerhalb dieses hervorgehobenen Bereiches angezeigt wird (Core Drive 3).
