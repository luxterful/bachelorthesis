...
Video-Marketing &nicht in Werbeclips \\
...
Begonnen wird der Leitfaden mit dem Start des Interviews. Der Befragte wird begrüßt und die Rahmenbedingungen für das Interview werden geklärt.
...
Als mögliche Gamification Mechaniken für diese Ziele könnten laut der Befragten vor allem Alerts dienen. So könnte ein Alert ausgelöst werden sobald ein Zuschauer dem Discord beitritt oder einen Merchandise Artikel kauft.

\subsection{Definition der Kampagnenziele}
...
Da bereits in \autoref{chap:bewertung_gamif} eine sehr starke Eingrenzung der Gamification Elemente stattgefunden hat, ist die Anzahl an möglichen Gamification Elementen überschaubar.

Zum einen können die zwei Badges VIP und Moderator über den IRC Chat an einen User vergeben werden. Die Anzahl der verfügbaren VIP Badges ist hierbei abhängig von dem Fortschritt im dazugehörigen Achievement wie in \autoref{chap:gami_achievements} beschrieben. Das VIP Badge kann in einer Kampagne als Belohnung verwendet werden.

Moderator Rollen können beliebig viele vergeben werden. Da diese Rolle aber viel Verantwortung mit sich bringt und nur an vertrauenswürdige User vergeben werden soll ist dieses Badge ungeeignet für eine Marketing Kampagne. Somit ist das VIP Badge das einzige native Gamification Element, das in Frage kommt.

Overlays bieten grenzenlose Kreativität
Aus diesem Grund wird sich in dieser Arbeit auf die zwei obigen Beispiele aus \autoref{chap:gami_overlays} begrenzt, da alles weitere den Rahmen sprengen würde.

Das gleiche gilt für die Chatbots
...
Da die Gamification Elemente auf Twitch bereits seit Jahren erfolgreich einsetzt kann davon ausgegangen werden dass diese auf die Zuschauerschaft abgestimmt sind. 

Da in dieser Arbeit auf die gleichen Elemente zurückgegriffen wird, ist eine separate Betrachtung der Spielertypen nicht notwendig.
...
Das Thema Gamification ist sehr umfassend. Es ist nicht möglich diese im Detail in einer Bachelorarbeit  umfangreich zu behandeln. 

Gamification Elemente wurde in Kategorien zusammengefasst. Hierdurch gehen details verloren.

Mit bestehenden Gamification Elementen 
