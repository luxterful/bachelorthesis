...
Auch Unternehmen in der Musikbranche nutzen mehr und mehr Social Media Plattformen um ihre Produkte und Dienstleistungen an den Konsumenten zu bringen. Mit einem geringerem Aufwand an analogen Mitteln, kann die Kraft der digitalen Werbung effektiv genutzt werden.
...
\begin{figure}[ht]
\caption{Twitch durchschnittliche gleichzeitige Zuschauer Q2'18 bis Q2'20 \parencite{May2020}}
\centering
...
% 
\chapter{Diskussion}
Das Thema Gamification ist sehr umfassend. Es ist nicht möglich dieses im Detail in einer Bachelorarbeit umfangreich zu behandeln. Aus diesem Grund wurden unter anderem die Overlays und Bots stark eingegrenzt. Es wurden nur die in der Praxis meist genutzten Beispiele behandelt. Dies führt zu einer einseitigen Betrachtung. Neben diesen gibt es aber auch viele neue Entwicklungen die zum Beispiel von Streamelements oder Streamlabs zu Verfügung gestellt werden. Diese könnten in einer weiteren Studie ebenfalls betrachtet werden.

Ebenfalls wurde davon ausgegangen, dass Twitch sich bewusst ist, aus welchen Spielertypen sich ihre Zuschauerschaft zusammensetzt. Hierzu gibt es leider keine öffentlich einsehbaren Informationen und noch keine Forschungen. Ebenfalls sind über die Effizienz der einzelnen Gamification Elemente auf Twitch noch keine Informationen auffindbar. Dies sollte in Zukünftigen Forschungen analysiert werden.
...
Zusammenfassend ist zu sagen, dass Twitch eine große Bandbreite an Gamification Elementen besitzt. 



Der Begriff Gamification ist sehr irreführend.

Er verleitet dazu zu sehr Elemente aus Spielen zu suchen und diese zu extrahieren um Sie in einem Spielfremden Kontext anzuwenden. 

Es ist wichtiger sich auf die psychologischen Aspekte und das Menschliche Verhalten zu fokusieren. 

Der Ansatz von You Kai Chou mit seinem Human-Focused Design ist ein erster Schritt in die Richtige Richtung
