...
Oberhalb des Chats befindet sich eine Liste mit den \glqq Top 10 Sub Giftern\grqq{} sowie den \glqq Top 10 Cheerern\grqq{}. Diese Liste wird auch Leaderboard genannt. Der Streamer kann bestimmen ob die Top 10 des Tages, der Woche, des Monats oder die Top 10 insgesamt angezeigt werden sollen. Das Leaderboard ist ein einfaches Mittel von Twitch den User dazu zu bewegen den Streamer weiter zu unterstützen. Durch das Verschenken von Subscriptions und das Cheeren kann er sich in der Rangliste nach oben kämpfen. Zudem müssen Sie den Streamer weiter unterstützen um nicht von anderen überholt zu werden. 
...
\subsection{Badges}
Wie bereits erwähnt sind Badges kleine Symbole. Sie werden im Chat links neben dem Usernamen angezeigt. Zur leichteren Orientierung werden die Badges in dieser Arbeit wie in \autoref{img:badges_overview} zu sehen in zwei Gruppen unterteilt. Diese Gruppen sind \glqq Channel-Badges\grqq{} und \glqq Global-Badges\grqq{}. Erstere sind nur in dem Channel aktiv in dem ein User diese auch freigeschaltet oder zugewiesen bekommen hat. Ein User kann diese in beliebig vielen Channels erhalten. Zweiteres sind auf der ganzen Plattform verfügbar Badges und werden in jedem Channel gleichermaßen angezeigt.
...
Die sogenannten Subscriber Badges bekommt ein User, der eine Subscription eines Streamers kauft. Hierdurch signalisiert er seine Loyalität gegenüber diesem, weshalb diese Badges auch oft Loyalty Badges genannt werden. Durch sie wird ebenfalls ein starkes Gemeinschafts- bzw. Community-Gefühl bei allen Badge-Besitzern erzeugt. 
...
Die Leaderboard Badges sind wie der Name schon sagt eng mit dem Leaderboard aus \autoref{chap:leaderboard} verknüpft. Diese beziehen sich auf den aktuellen Rang im Leaderboard. Sie werden an die Plätze 1 bis 3 des Leaderboards vergeben. Deshalb muss ein User auch weiterhin den Streamer unterstützen, um nicht von einem anderen User überholt zu werden.

Core Drive 

\subsubsection{Hype Train Conductor}
...
Ist der HypeTrain abgeschlossen so erhält der User mit den meisten Spenden den goldenen HypeTrain Conductor Badge als Belohnung. Im nächsten HypeTrain kann dieser User das goldene Badge aber wieder verlieren, wenn ein anderer User diese Rolle übernimmt. Hierbei erhält der ehemalige Besitzer ein neues permanentes lila \glqq Former Conductor\grqq{}-Badge, das einzeigt, dass er einmal der HypeTrain Conductor war.

Core Drive

\subsubsection{Sonderaktionen Badges}

Hin und wieder vergibt Twitch auch weitere Badges für besondere Aktionen oder Anlässe. 
Ein Beispiel hierfür ist die TwitchCon, eine Messe die von Twitch einmal im Jahr abgehalten wird. Jeder Besucher der Messe erhält ein Chat-Badge, das ihn als Teilnehmer der Messe auszeichnet. Auch Charity Events wie Beispielsweise "Holiday Season of Giving" im Jahr 2018 zählen hier dazu. Pro 100 Bits die im Zeitraum vom 12. - 27. Dezember 2018 gespendent wurden, hat Twitch 20ct an Wohltätige Zwecke gespendet. Jeder der in diesem Zeitraum mindestens 100 Bits mit dem Hashtag \#Charity gespendet hat, wurde mit einem Schneflocken Badge ausgezeichnet. \parencite{Twitch2018a}
...
\label{img:chan_pts}
\centering
\includegraphics[width=0.5\textwidth]{twitch_channelpoints_earning}
\end{figure}
...
Hat ein Zuschauer eine Subscription gekauft, so wird dies im Chat besonders hervorgehoben. Der Zuschauer hat auch die Möglichkeit eine Nachricht zu schreiben, die innerhalb dieses hervorgehobenen Bereiches angezeigt wird.

Somit fühlt sich der Zuschauer mehr wertgeschätzt. 
