...
\label{chap:gamif}
Spiele erfreuen sich seit vielen Jahren großer Beliebtheit. Sei es Brettspiele, sportliche Wettbewerbe oder seit der Entwicklung des Computers auch Videospiele. Aufgrund des großen Erfolges von Spielen wurde begonnen dessen Hintergründe zu erforschen. Das Ziel ist es herauszufinden weshalb sie so beliebt sind und was sie so faszinierend und fesselnd macht. \parencite{Prensky2001}

Bei diesen Untersuchungen ist man auf eine Erkenntnis gestoßen. Es gibt bestimmte Elemente in Spielen die besonders stark zur Motivation und Faszination eines Spielers beitragen. Aus dieser Erkenntnis ist die Forschung der Gamification entstanden. Gamification ist ein Begriff der bereits seit einigen Jahren in vielen Bereichen Anwendung findet. 

Nachdem lange Verwirrung um eine genaue Definition von Gamification bestand definierte \textcite{Deterding2011} es wie folgt: \glqq Gamification is the use of game design elements in non-game contexts\grqq. Somit ist Gamification die Anwendung von Elementen aus Spielen in nicht-spiel Umgebungen beziehungsweise deren Kontext. Die Eingangs erwähnten Elemente sind unter anderem Punkte, Badges oder Leaderboards. Diese werden auch kurz \glqq PBLs\grqq genannt.

Jedoch wird auch oft fälschlicherweise angenommen, dass das alleinige hinzufügen dieser Elemente bereits Gamification ist. Dabei entsteht eine Verwechslung mit Pointification. Diese ist das reine Anwenden von PBLs auf ein System ohne durchdachtes System, in der Hoffnung, dass es den Benutzer motiviert.
...
Um das HFD erfolgreich einsetzen zu können muss bei der Entwicklung der Gamification Strategie das Entwicklungsteam sich seiner zukünftigen Zielgruppe bewusst sein. Um das zu erleichtern wurden für Gamification die Spieltertypen entwickelt. Hierfür gibt es verschiedenen Modelle. Diese finden in verschiedenen Bereichen Anwendung. Beispielsweise gibt es die Spielertypen nach Bartels die in vier verschiedene Player aufgeteilt werden. Jedoch ist dieser Ansatz für Rollenspiele spezialisiert. 
