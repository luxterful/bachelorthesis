...
Bei Gamification wird ein besonderes Augenmerk auf den User, dessen Verhalten, Bedürfnisse, Wünsche und Emotionen gelegt. Dieses vorgehen wird "Human-Focused Design" genannt. Im Gegensatz dazu wird beim Klassischen "Function-Focused Design" der Augenmerkt auf die durchzuführenden Arbeit und die hierfür möglichst effiziente funktionale Lösung gelegt. 
\parencite{Mechelen2017}
...
Jedem Menschen können die verschiedenen Spielertypen in verschiedener Ausprägung zugeschrieben werden. 
...
Leider gibt es keine konkrete Information zu den Erfolg einzelner Marketing Methoden.
...
\textbf{andere Badges}
TwitchCon ist eine Messe die von Twitch einmal im Jahr abgehalten
...
\subsection{Auswahlt der passenden Gamification Elemente}
